      ...
      <div class="container-fluid">
        ...
        <?php
                ...
                if ($error == "yes") {
                  ...
                  echo "<div class='alert alert-success'><b>Success!</b> The inventory stock expire medicine has been updated.</div>";
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-12">
            ...
            <div class="small-box bg-info">
              ...
              <a href="admin.inventory.php?mode=3" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-12">
           ...
           <h3><?php echo $gsql4['staff']; ?></h3>
              ...
              <a href="admin.staffsection.php?mode=5" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
