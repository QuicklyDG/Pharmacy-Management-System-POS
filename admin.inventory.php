...
<div class="wrapper">
   ...
   <!-- Main content -->
    <section class="content">
              ...
              <div class="card-header bg-gradient-red display-flex">
                ...
                <h3 class="card-title float-right"> <button class="btn bg-gradient-green float-right"  rel="tooltip" title="Add Medicine/Drugs" data-toggle="modal" data-target="#addinventory"><i class="fa fa-plus"></i></button> </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <?php
                ...
                <table id="example1" class="table table-bordered table-striped"> 
                  ...
                  <td><button class="btn bg-gradient-green" rel="tooltip" title="Edit Medicine" data-toggle="modal" data-target="#editinventory<?php echo $rows['id']; ?>"><i class="fa fa-edit"></i></button>
                  
                  <button class="btn bg-gradient-red" rel="tooltip" title="Remove Medicine" data-toggle="modal" data-target="#delinventory<?php echo $rows['id']; ?>"><i class="fa fa-trash" ></i></button> 

                  <button class="btn bg-gradient-blue" rel="tooltip" title="Add Stock" data-toggle="modal" data-target="#addstock<?php echo $rows['id']; ?>"><i class="fa fa-layer-group"></i></button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer bg-gradient-red justify-content-between">
              <a type="button" href="includes/deleteinventory.php?id=<?php echo $rows['id']; ?>" class="btn bg-gradient-blue">Remove Medicine</a>
 ...
 <div class="modal fade" id="stockhistory<?php echo $rows['id']; ?>">
      ...
      <!-- /.modal -->
                                   ...
                                   <!-- modal -->
                                   <div class="modal fade" id="editinventory<?php echo $rows['id']; ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header bg-gradient-red">
              <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Medicine/Drugs</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                ...
                <form action="includes/editinventory.php?id=<?php echo $rows['id']; ?>" method="POST">
                      <div class="text-left">
                  <div class="form-group">
                    <label>Main Category:</label>
                    <select name="maincat" class="form-control form-control-lg">
                      <option><?php echo $rows['maincat'];?></option>
                      <?php 
                  ...
                  <div class="form-group">
                    ...
                    <select name="subcat" class="form-control form-control-lg">
                      <option><?php echo $rows['subcat'];?></option>
                      <?php 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="medicine" class="form-control form-control-lg" value="<?php echo $rows['meds'];?>">
                  </div>

                  <div class="form-group">
                    <label>Brand:</label>
                    <select name="brand" id="discount-select" class="form-control form-control-lg" value="<?php echo $rows['brand'];?>">
                    <option><?php echo $rows['brand'];?></option>        
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="descript" class="form-control form-control-lg" value="<?php echo $rows['descript'];?>">
                  </div>
                  
                  <div class="form-group">
                    <label>Manufactured Date:</label>
                    <input type="date" name="mdate" class="form-control form-control-lg" value="<?php echo $rows['mdate'];?>">
                  </div>
                 
                  <div class="form-group">
                    <label>Expiration Date:</label>
                    <input type="date" name="exdate" class="form-control form-control-lg" value="<?php echo $rows['exdate'];?>">
                  </div>
                 
                  <div class="form-group">
                    <label>Stock:</label>
                    <input type="number" name="stock" class="form-control form-control-lg" value="<?php echo $rows['stock'];?>">
                  </div>
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="number" step="any" name="originalprice" class="form-control form-control-lg" value="<?php echo $rows['origprice'];?>">
                  </div>
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="number" step="any" name="sellingprice" class="form-control form-control-lg" value="<?php echo $rows['sellprice'];?>">
                  </div>
                 
                  <div class="form-group">
                    <label>Auth:</label>
                    <input type="text" name="auth" class="form-control form-control-lg" value="<?php echo $rows['auth'];?>">
                  </div>
                  </div>

                  <div class="form-group">
                    <button class="btn bg-gradient-blue btn-block" type="submit" name="updateinv">UPDATE MEDICINE</button>
                  </div>
          ...
          <div class="modal-content" style="width:600px;">
            ...
            <div class="modal-body">
                ...
                <form action="includes/saveinventory.php" method="POST">
                  ...
                  <div class="form-group">
                    <label>Brand:</label>
                    <select name="brand" id="discount-select" class="form-control form-control-lg">
                    <option></option>        
                      <option>Branded</option>
                      <option>Generic</option> 
                    </select>
                  ...
                  <div class="form-group">
                    <label>Description:</label>
                    <input type="text" name="descript" class="form-control form-control-lg" >
                  </div>                                           
                  <div class="form-group">
                    <label>Manufactured Date:</label>
                  ...
                  <div class="form-group">
                    ...
                    <select name="auth" class="form-control form-control-lg">
                    <option>NO</option>        
                      <option>YES</option>
                    </select>
                  </div>
